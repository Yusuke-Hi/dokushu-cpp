...
public:
    product(int id_, int price_, int stock_);
...
product::product(int id_, int price_, int stock_):
    id(id_), price(price_), stock(stock_) {}
...
int main()
{
    product pen(1, 300, 400); // ペンに関するデータを持つ変数
